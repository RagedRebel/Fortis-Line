      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
            <h1 className="text-3xl font-bold text-[#016B61] text-center mb-2">Track Your Complaint</h1>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className={`mt-2 w-full rounded-xl border ${isInvalid ? 'border-red-400' : 'border-gray-300'} focus:border-[#016B61] focus:ring-[#016B61] shadow-sm px-4 py-2.5`}
                />
                {isInvalid && (
