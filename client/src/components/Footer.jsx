        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-blue-200 hover:text-white transition transform hover:scale-110">
            ...
            <div className="space-y-3 text-blue-200 text-sm">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <a href="mailto:helpline@antiragging.net" className="hover:text-white transition">
          ...
          <div>
            ...
            <div className="space-y-2 text-blue-200 text-sm">
              ...
              <a href="mailto:committee@antiragging.net" className="block hover:text-white transition pt-2">
          ...
          <div>
            ...
            <div className="space-y-2 text-blue-200 text-sm">
              <a href="#" className="block hover:text-white hover:translate-x-1 transition transform">
