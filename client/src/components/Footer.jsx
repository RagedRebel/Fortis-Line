function Footer() {
  ...
  return (
    <footer className="bg-[#016B61] text-white mt-auto">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-[#70B2B2] rounded-lg flex items-center justify-center">
                <span className="text-2xl">🛡️</span>
              </div>
              <h3 className="text-xl font-bold">FortisLine</h3>
            </div>
            <p className="text-[#E5E9C5] text-sm leading-relaxed">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="cursor-pointer text-[#E5E9C5] hover:text-white transition-colors duration-300 transform hover:scale-110 ">
          ...
          <div>
            ...
            <div className="space-y-3 text-[#E5E9C5] text-sm">
          ...
          <div>
            ...
            <div className="space-y-2 text-[#E5E9C5] text-sm">
              <div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#70B2B2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-[#E5E9C5] text-sm text-center md:text-left">
              © {currentYear} FortisLine - Anti-Ragging Initiative. All rights reserved.
            </p>
            <div className="flex space-x-6 text-[#E5E9C5] text-sm">
